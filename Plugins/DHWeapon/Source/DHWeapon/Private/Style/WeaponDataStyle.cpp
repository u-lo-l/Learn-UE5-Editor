...
TSharedPtr<FSlateBrush> FWeaponDataStyle::ActorDataBackGroundColor
	= MakeShareable(new FSlateColorBrush(FLinearColor(0.175f, 0.125f, 0.05f, 1.f)));
TSharedPtr<FSlateBrush> FWeaponDataStyle::EquipDataBackGroundColor
	= MakeShareable(new FSlateColorBrush(FLinearColor(0.05f, 0.1f, 0.025f, 1.f)));
TSharedPtr<FSlateBrush> FWeaponDataStyle::ActionDataBackGroundColor
	= MakeShareable(new FSlateColorBrush(FLinearColor(0.07f, 0.1f, 0.125f, 1.f)));
TSharedPtr<FSlateBrush> FWeaponDataStyle::DamageDataBackGroundColor
	= MakeShareable(new FSlateColorBrush(FLinearColor(0.075f, 0.025f, 0.025f, 1.f)));
