#include "ActorDataInfoDetails.h"
...
void FActorDataInfoDetails::CustomizeChildren( TSharedRef<IPropertyHandle> PropertyHandle,
	...
	IPropertyTypeCustomizationUtils & CustomizationUtils )
{
	MeshSection(PropertyHandle, ChildBuilder, CustomizationUtils);
	ColliderSection(PropertyHandle, ChildBuilder, CustomizationUtils);
}
...
)
{
	TSharedRef<IPropertyHandle> WeaponMeshHandle
		= PropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FWeaponActorData, WeaponMeshes)).ToSharedRef();
	TSharedRef<IPropertyHandle> SocketNameHandle
		= PropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FWeaponActorData, SocketNameToAttachMesh)).ToSharedRef();
...
)
{
	TSharedRef<IPropertyHandle> ColliderHandle
		= PropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FWeaponActorData, Colliders)).ToSharedRef();
